...
@click.command()
@click.option("--cluster", help="production-cluster", required=True)
@click.option("--service", help="production-service", required=True)
@click.option("--image", help="534950101999.dkr.ecr.us-east-1.amazonaws.com/django-app:latest", required=True)
